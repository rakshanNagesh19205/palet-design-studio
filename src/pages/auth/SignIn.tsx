        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 pb-8">
          <div className="w-full max-w-[340px]">
            ...
            <div className="flex gap-1 p-1 bg-[#f0efef] rounded-lg mb-8">
              <Link
                to="/auth/signup"
                className="flex-1 py-2.5 text-center text-sm font-medium rounded-md text-muted-foreground hover:text-foreground transition-colors"
              >
                Sign up
              </Link>
              <button className="flex-1 py-2.5 text-center text-sm font-medium rounded-md bg-white text-slate-900 shadow-sm">
                Sign in
              </button>
            </div>
